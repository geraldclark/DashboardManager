...
$dictionary["dash_dashboardmanager_users_2"] = array (
  ...
  'table' => 'dash_dashboardmanager_users_2_c',
  'fields' => 
  array (
    0 => 
    array (
    ...
    4 => 
    array (
      'name' => 'dash_dashboardmanager_users_2users_idb',
      'type' => 'varchar',
      'len' => 36,
    ),
  ),
  ...
  array (
    0 => 
    array (
      'name' => 'dash_dashboardmanager_users_2spk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
    ...
    1 => 
    array (
      'name' => 'dash_dashboardmanager_users_2_ida1',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'dash_dashboardmanager_users_2dash_dashboardmanager_ida',
      ),
    ),
    2 => 
    array (
      'name' => 'dash_dashboardmanager_users_2_alt',
      'type' => 'alternate_key',
      'fields' => 
      array (
        0 => 'dash_dashboardmanager_users_2users_idb',
      ),
    ),
  ),
);